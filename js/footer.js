...
(function () {
  ...
  var contactLink = mount.querySelector('a[href$="index.html#kontakt"]');
  if (contactLink) {
    var gastroLink = document.createElement("a");
    gastroLink.href = base + "pages/gastronomie-kassensystem.html";
    gastroLink.textContent = "Gastronomie";
    contactLink.parentNode.insertBefore(gastroLink, contactLink);
  }
})();
